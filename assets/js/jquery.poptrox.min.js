/* jquery.poptrox.js v2.5.2-dev | (c) @ajlkn | github.com/ajlkn/jquery.poptrox | MIT licensed */ ! function(e) {
    ...
    e.fn.poptrox = function(o)
    {
      ...
      return l.on("resize orientationchange", function() {
        ...
        // .css("vertical-align", "none")
        x.css("display", "inline-block").css("position", "relative").css("z-index", 1).css("cursor", "auto").appendTo(a).hide().on("poptrox_next", function() {
          var e = d + 1;
          ...
          if ("ignore" != n && i.attr("href")) {
            ...
            switch (p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/), t.type) {
              ...
              case "soundcloud":
                ...
                break;
              case "youtube":
                t.object = e('<iframe src="" frameborder="0" allowfullscreen="1"></iframe>'), t.src = "//www.youtube.com/embed/" + p[1] + (t.options ? "?" + t.options : ""), t.width && t.height || (t.width = iframe_width, t.height = iframe_height);
                break;
              case "vimeo":
